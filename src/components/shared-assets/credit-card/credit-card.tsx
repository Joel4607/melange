...
const styles = sortCx({
    ...
    "brand-dark": {
        root: "bg-linear-to-tr from-green-deep to-green before:pointer-events-none before:absolute before:inset-0 before:z-1 before:rounded-[inherit] before:ring-1 before:ring-white/30 before:ring-inset",
        company: "text-white",
        footerText: "text-white",
        paypassIcon: "text-cream",
        cardTypeRoot: "bg-white/10",
    },
    "brand-light": {
        root: "bg-cream before:pointer-events-none before:absolute before:inset-0 before:z-1 before:rounded-[inherit] before:ring-1 before:ring-cream-deep before:ring-inset",
        company: "text-ink",
        footerText: "text-ink",
        paypassIcon: "text-green-deep",
        cardTypeRoot: "bg-cream-deep",
    },
    "gray-dark": {
        ...
        >
            ...
            >
                ...
                {VERTICAL_STRIP_TYPES.includes(type as (typeof VERTICAL_STRIP_TYPES)[number]) && (
                    <div className="pointer-events-none absolute inset-y-0 left-0 z-0 w-[5.5rem] bg-neutral-800"></div>
                )}
                {/* Gradient diffusor */}
                ...
                <div className="relative flex items-start justify-between px-1 pt-1">
                    <div className={cx("text-base leading-[normal] font-semibold", styles[type].company)}>{company}</div>
                ...
                <div className="relative flex items-end justify-between gap-3">
                    <div className="flex min-w-0 flex-col gap-2">
                        ...
                        <div className={cx("text-sm leading-[normal] font-semibold tracking-[1px] tabular-nums", styles[type].footerText)}>
                            {cardNumber}
                    ...
                    <div className={cx("flex h-8 w-11 shrink-0 items-center justify-center rounded", styles[type].cardTypeRoot)}>
